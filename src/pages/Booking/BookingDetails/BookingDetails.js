      ...
      <div className='w-full  px-5 py-10 m-auto mt-10 bg-white rounded-lg shadow dark:bg-gray-800'>
        <div className='mb-6 text-3xl font-bold text-center text-gray-800 dark:text-white'>
          ...
          <span className='text-span-text'>
            {" "}
            The Service {booking.serviceName}
          </span>
        </div>
        <div className='grid max-w-xl grid-cols-2 gap-4 m-auto'>
          ...
          <div className='md:col-span-2 lg:col-span-2'>
            <div className='currency-wrap relative'>
              ...
              <input
                ...
                type='number'
                id='contact-form-email'
                className=' text-currency flex-1 appearance-none border border-pink-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent'
                readOnly
                onBlur={handleOnBlur}
          ...
          <div className='col-span-2'>
            <button
              ...
              type='submit'
              className='uppercase my-6 py-2 px-4 rounded-lg bg-pink-500 border-2 border-transparent text-white text-md mr-4 hover:bg-pink-400'
            >
              Submit
            </button>
          </div>
