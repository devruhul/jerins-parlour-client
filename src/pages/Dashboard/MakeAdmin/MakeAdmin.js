...
const MakeAdmin = () => {
    ...
    const handleMakeAdmin = (e) => {
        e.preventDefault();
        const user = { email };
        fetch('https://jerins-parlour-backend.vercel.app/users/makeAdmin', {
            method: 'PUT',
            headers: {
                    ...
                    <div className="grid  grid-cols-2 gap-6 mx-auto">
                        <div className="md:col-span-2 lg:col-span-2">
                            <div className=" relative ">
                                <input name="email" type="email" id="contact-form-admin-email" className="flex-1 appearance-none border border-pink-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                                    required
