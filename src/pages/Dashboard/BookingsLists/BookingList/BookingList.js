...
const BookingList = ({ serviceImg, serviceDescription, orderStatus, serviceTitle, _id }) => {
        ...
        <div className="xl:w-1/3 md:w-1/2 p-10">
            <div className="border border-gray-200 p-6 rounded-lg">
                ...
                <div className='text-right'>
                    <h2 className="text-lg text-gray-900 font-medium title-font m-2">{serviceTitle}</h2>
