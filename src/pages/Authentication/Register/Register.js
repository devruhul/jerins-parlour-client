        ...
        <form autoComplete='off' onSubmit={signUpUsingEmail}>
          <div className='flex flex-col mb-4'>
            <div className='flex relative '>
              ...
              <input
                ...
                onBlur={handleOnBlur}
                id='sign-up-name'
                className='flex-1 appearance-none border border-pink-300 w-full py-3 px-4 bg-white text-gray-700 placeholder-gray-400 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent'
          ...
          <div className='flex items-center mb-6 -mt-4'>
            <div className='flex ml-auto'>
              <a
                href='/#'
                className='inline-flex text-4xl text-gray-500 sm:text-lg dark:text-gray-100 hover:text-gray-700 dark:hover:text-white'
              >
