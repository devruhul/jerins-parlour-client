...
const Login = () => {
  ...
  const { signInParlourUser, signInWithGoogle } = useAuth();
  ...
  return (
    <div className='flex flex-col w-full mx-auto max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10'>
        ...
        <form autoComplete='off' onSubmit={handleloginSubmit}>
          ...
          <div className='flex items-center mb-6 -mt-4'>
            <div className='flex ml-auto'>
              <a
                href='/#'
                className='inline-flex text-lg font-thin text-gray-500 sm:text-sm dark:text-gray-100 hover:text-gray-700 dark:hover:text-white'
              >
          ...
          <div className='flex w-full'>
            <button
              type='submit'
              className='  focus:ring-purple-500 focus:ring-offset-purple-200  w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2   uppercase my-2 py-2
      ...
      <div className='flex items-center justify-center mt-6'>
        ...
        >
          <span className='ml-2 text-2xl'>You don't have an account?</span>
        </Link>
      </div>
    </div>
  );
