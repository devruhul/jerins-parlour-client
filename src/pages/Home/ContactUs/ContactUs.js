...
const ContactUs = () => {
    return (
        <div className="bg-light-tomato">
            <form class="flex w-full max-w-sm space-y-3 mx-auto">
                <div class="w-full  px-5 py-10 m-auto mb-10 mt-10 rounded-lg shadow-lg dark:bg-gray-800">
                    ...
                    <div class="grid  grid-cols-2 gap-6 m-auto">
